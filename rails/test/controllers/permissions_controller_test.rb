...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference("Permission.count") do
      post permissions_url, params: { permission: { id: @permission.id, permission_type: @permission.permission_type } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { id: @permission.id, permission_type: @permission.permission_type } }
